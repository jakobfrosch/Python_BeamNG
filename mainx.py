...
if __name__ == '__main__':
    ...
    bng = BeamNGpy('localhost', 64256, home='D:\BeamNG.tech.v0.30.6.0\BeamNG.tech.v0.30.6.0', user='C:\\Users\Stefan\AppData\Local\BeamNG.drive')
    bng.open(launch=True)
    scenario = Scenario('smallgrid', 'roads_sensor_demo', description='Spanning the map with the roads sensor')
    vehicle = Vehicle('ego_vehicle', model='etk800', license='RED', color='Red')
    scenario.add_vehicle(vehicle, pos=(1.75, -17.12251064972856, 5.0), rot_quat=angle_to_quat((0, 0, 270)))
    scenario.make(bng)
